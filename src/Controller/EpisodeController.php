...
class EpisodeController extends AbstractController
{
    ...
    /**
     * @Route("/{episode}", requirements={"program"="[\w\-]+"}, name="episode_show", methods={"GET"})
    ...
    public function edit(Request $request, Episode $episode, Slugify $slugify, Comment $comment): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $this->addFlash('success', 'L\'épisode a bien été édité');
            return $this->redirectToRoute('episode_index');
        }
    ...
    /**
     * @Route("/{episode}", requirements={"program"="[\w\-]+"}, name="episode_delete", methods={"DELETE"})
     * @ParamConverter("episode", class="App\Entity\Episode", options={"mapping": {"episode": "slug"}})
     */
    public function delete(Request $request, Episode $episode): Response
    {
        if ($this->isCsrfTokenValid('delete'.$episode->getId(), $request->request->get('_token'))) {
            ...
            $entityManager->flush();
            $this->addFlash('danger', 'L\'épisode ' . $episode->getTitle() . ' a bien été supprimé');
        }
